import { User, Building2, FileText, Wallet, CheckCircle, BadgeCheck } from 'lucide-react';
...
import BusinessInformationStep from './multistep/BusinessInformationStep';
import ContentPreferenceStep from './multistep/ContentPreferenceStep';
...
const steps = [
    ...
    },
    {
        ...
        description: 'Select your content preferences',
        icon: FileText,
    },
    {
        number: 3,
...
export default function DCDSignup() {
        ...
        <div className="min-h-screen bg-zinc-50 dark:bg-neutral-900 py-8 px-4">
            ...
            <div className="mb-8 text-center">
                <h1 className="mb-2 text-3xl font-bold">
                    Digital Content Distributor Registration
                </h1>
            </div>
                ...
                <Card className="hidden lg:block shadow-xl col-span-7 lg:col-span-3 px-8 bg-linear-to-t dark:from-neutral-900 dark:to-neutral-800 from-green-50 to-blue-50 dark:border-neutral-700 border rounded-xl">
                    <div className="flex gap-4 mb-8 pt-6 items-center">
                        ...
                        <div>
                            ...
                            <p className="text-muted-foreground">
                                Complete all steps to join our distributor program
                            </p>
                        </div>
                    </div>
                    <div>
