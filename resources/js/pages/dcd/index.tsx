      ...
      <div className="relative max-w-6xl mx-auto py-20 px-6 lg:px-8">
            ...
            <div className="flex flex-col md:flex-row items-center gap-8 md:gap-12 p-6">
              <div className="flex-1 text-center md:text-left">
                ...
                <p className="text-muted-foreground text-lg mb-0 leading-relaxed">
                  Discover how the DCD program empowers you to distribute digital content and earn through network growth.
                </p>
              </div>
        ...
        <section>
          <div className='w-full flex justify-center'>
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-indigo-50 border border-indigo-100 mb-6">
              ...
              <span className="text-xs font-bold uppercase tracking-wider text-indigo-700">Now Open for Distributors</span>
            </div>
          </div>
            ...
            {[
              {
                ...
                desc: "Earn commissions from every digital content transaction processed through your network.",
                icon: Percent,
              ...
              },
              {
                ...
                desc: "Build and manage a diverse portfolio of digital content across multiple platforms.",
                icon: TrendingUp,
              ...
              },
              {
                ...
                desc: "Generate ongoing revenue from automated content distribution and licensing.",
                icon: Wallet,
                color: "text-blue-600",
                bg: "bg-blue-50"
              }
        ...
        <section className="relative bg-linear-to-t dark:from-neutral-900 dark:to-neutral-800 from-green-50 to-blue-50 dark:border-neutral-700 border rounded-3xl p-8 mb-18 shadow-sm overflow-hidden">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 divide-y md:divide-y-0 md:divide-x divide-slate-100">
            {[
              { label: "Active Distributors", value: "250+", icon: Users },
              { label: "Content Distributed", value: "10K+", icon: Wallet },
              { label: "Revenue Generated", value: "$75K+", icon: BadgeCheck }
            ].map((stat, i) => (
        ...
        <section className="text-center relative">
          ...
          <div className="mt-8 flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-8 text-slate-400 text-sm font-medium">
            <div className="flex items-center gap-2">
              <BadgeCheck className="w-4 h-4 text-emerald-500" /> No setup fees
            </div>
            <div className="flex items-center gap-2">
              <BadgeCheck className="w-4 h-4 text-emerald-500" /> Start in minutes
            </div>
          </div>
        </section>
      </div>
