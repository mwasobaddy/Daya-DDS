...
class StoreDaRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        $rules = [
            ...
            'social_platforms.instagram' => 'nullable|string|in:Less than 1K,1K-10K,10K-50K,50K-100K,100K+',
            'social_platforms.x' => 'nullable|string|in:Less than 1K,1K-10K,10K-50K,50K-100K,100K+',
            'social_platforms.twitter' => 'nullable|string|in:Less than 1K,1K-10K,10K-50K,50K-100K,100K+',
            'social_platforms.facebook' => 'nullable|string|in:Less than 1K,1K-10K,10K-50K,50K-100K,100K+',
            'social_platforms.tiktok' => 'nullable|string|in:Less than 1K,1K-10K,10K-50K,50K-100K,100K+',
