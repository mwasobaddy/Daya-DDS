...
class StoreClientRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        $rules = [
            ...
            'campaignObjective' => 'required|in:music_promotion,app_downloads,product_launch,events_promotions,surveys,product_promotion,apartment_listing,education_learning,civic_political,movies,games',
            'campaignName' => 'required|string|max:255',
            'campaignDescription' => 'required|string|min:50|max:2000',
            'digitalProductLink' => 'required|url',
            'explainerVideoLink' => 'nullable|url',
